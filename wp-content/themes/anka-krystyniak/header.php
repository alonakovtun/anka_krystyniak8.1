...
<head>
	...
	<!-- Global site tag (gtag.js) - Google Ads: 1019958199 -->
	<script async src="https://www.googletagmanager.com/gtag/js?id=AW-1019958199"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'AW-1019958199');
	</script>
	...
	<? if (is_singular('product')): ?>
		<!-- PayU mini widget script -->
		<script src="https://static.payu.com/res/v2/widget-mini-installments.js"></script>
		<!-- End PayU mini widget script -->
	<? endif; ?>
