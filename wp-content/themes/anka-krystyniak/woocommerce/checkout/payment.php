...
<div id="payment" class="woocommerce-checkout-payment">
	<h3 class="ak-checkout-form__section-title ak-checkout-form__section-title--border-top">
		<? _e('Payment method', 'anka-krystyniak'); ?>
	</h3>
	...
	<div class="form-row place-order">
		...
		<label for="checkout-form-consent" class="ak-checkbox consent-checkbox checkout-consent-checkbox">
			...
			<span><?= sprintf(__('I have read and agree website <a href="%s" target="_blank">Terms and conditions</a>', 'anka-krystyniak'), esc_url(get_permalink(84))); ?></span>
		</label>
