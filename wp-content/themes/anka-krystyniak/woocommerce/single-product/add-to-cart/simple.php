...
<?php else : ?>
	<div class="ak-product__add-to-cart-form">
		<button type="submit" class="single_add_to_cart_button button disabled"><?php echo __('Product not available', 'anka-krystyniak'); ?><span class="price"><?= $product->get_price_html(); ?></span></button>
	</div>
