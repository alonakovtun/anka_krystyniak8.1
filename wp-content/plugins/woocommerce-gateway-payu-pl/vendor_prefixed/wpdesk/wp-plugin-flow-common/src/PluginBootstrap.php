...
namespace WGPayuVendor\WPDesk\Plugin\Flow;
...
final class PluginBootstrap
{
     ...
     */
    public function __construct($plugin_version, $plugin_release_timestamp, $plugin_name, $plugin_class_name, $plugin_text_domain, $plugin_dir, $plugin_file, array $requirements, $product_id, \WGPayuVendor\WPDesk\Plugin\Flow\Initialization\InitializationFactory $build_factory, $plugin_shops)
    {
     ...
     */
    private function init_translations(\WGPayuVendor\WPDesk_Plugin_Info $plugin_info)
    {
        $lang_dir = 'lang';
    ...
    private function create_requirements_checker()
    {
        ...
        $requirements_checker_factory = new \WGPayuVendor\WPDesk_Basic_Requirement_Checker_Factory();
    ...
    {
        $plugin_info = new \WGPayuVendor\WPDesk_Plugin_Info();
