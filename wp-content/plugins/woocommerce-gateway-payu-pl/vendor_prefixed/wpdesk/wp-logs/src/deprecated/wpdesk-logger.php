...
if (!\class_exists('WGPayuVendor\\WPDesk_Logger')) {
    /**
    ...
    class WPDesk_Logger
    {
        ...
        {
            if (!self::$logger) {
                $loggerFactroy = new \WGPayuVendor\WPDesk\Logger\WPDeskLoggerFactory();
        ...
        {
            return ['disabled' => \__('Disabled', 'wp-logs'), 'emergency' => \__('Emergency', 'wp-logs'), 'alert' => \__('Alert', 'wp-logs'), 'critical' => \__('Critical', 'wp-logs'), 'error' => \__('Error', 'wp-logs'), 'warning' => \__('Warning', 'wp-logs'), 'notice' => \__('Notice', 'wp-logs'), 'info' => \__('Info', 'wp-logs'), 'debug' => \__('Debug', 'wp-logs')];
        }
        /**
         * @param string $level
         * @param string $source
