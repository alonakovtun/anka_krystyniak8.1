...
namespace WGPayuVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \WGPayuVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'wp-logs'),
            $dir
        ), \WGPayuVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \WGPayuVendor\WPDesk\Notice\Notice(\sprintf(
            // Translators: directory.
            \__('Can not enable WP Desk Debug log! Cannot create file %s!', 'wp-logs'),
            $file
        ), \WGPayuVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
