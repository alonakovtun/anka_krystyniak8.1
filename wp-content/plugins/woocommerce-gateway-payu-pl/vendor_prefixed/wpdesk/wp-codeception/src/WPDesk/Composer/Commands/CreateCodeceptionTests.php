 ...
 */
class CreateCodeceptionTests extends \WGPayuVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \WGPayuVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**
