...
trait LocalCodeceptionTrait
{
    ...
    {
        try {
            $wpdesk_configuration = \WGPayuVendor\Symfony\Component\Yaml\Yaml::parseFile(\getcwd() . '/tests/codeception/wpdesk.yml');
        } catch (\WGPayuVendor\Symfony\Component\Yaml\Exception\ParseException $e) {
            $wpdesk_configuration = array();
        }
        return \WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration::createFromEnvAndConfiguration($wpdesk_configuration);
    }
    /**
     * @param OutputInterface $output
     * @param Configuration   $configuration
     */
    private function prepareWpConfig(\WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output, \WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param Configuration   $configuration
     */
    private function activatePlugins(\WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output, \WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     */
    private function executeWpCliAndOutput($command, \WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output, $apache_document_root)
    {
     ...
     * @param bool            $coverage
     */
    private function installPlugin(string $plugin_dir, \WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output, \WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, bool $coverage = \true)
    {
     ...
     * @return string
     */
    private function prepareTargetDir($plugin_slug, \WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration)
    {
     ...
     * @param OutputInterface $output
     */
    private function prepareCommonWpWcConfiguration(\WGPayuVendor\WPDesk\Composer\Codeception\Commands\Configuration $configuration, \WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output)
    {
     ...
     */
    private function prepareLocalCodeceptionTests(\WGPayuVendor\Symfony\Component\Console\Input\InputInterface $input, \WGPayuVendor\Symfony\Component\Console\Output\OutputInterface $output, bool $coverage = \false)
    {
