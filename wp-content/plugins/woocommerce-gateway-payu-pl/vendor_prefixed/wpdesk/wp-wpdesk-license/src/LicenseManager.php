...
use WGPayuVendor\WPDesk\License\WpUpgrader\SubscriptionHandler;
...
class LicenseManager implements \WGPayuVendor\WPDesk\PluginBuilder\Plugin\HookableCollection
{
    ...
    {
        $this->add_hookable(new \WGPayuVendor\WPDesk\License\WpUpgrader\SubscriptionHandler($this->plugin_info->get_plugin_file_name(), $activated, $subscriptions_url));
    }
    /**
     * .
     */
